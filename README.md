# @wemnyelezxnpm/vitae-eius-molestiae

[![codecov](https://codecov.io/gh/SalmonMode/@wemnyelezxnpm/vitae-eius-molestiae/branch/main/graph/badge.svg?token=E28MMT0TC6)](https://codecov.io/gh/SalmonMode/@wemnyelezxnpm/vitae-eius-molestiae)
[![Build](https://github.com/wemnyelezxnpm/vitae-eius-molestiae/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/wemnyelezxnpm/vitae-eius-molestiae/actions/workflows/npm-publish.yml)
[![Package status](https://img.shields.io/npm/v/@wemnyelezxnpm/vitae-eius-molestiae.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/vitae-eius-molestiae)
[![License](https://img.shields.io/npm/l/@wemnyelezxnpm/vitae-eius-molestiae.svg)](https://opensource.org/licenses/MIT)
...
```bash
npm install @wemnyelezxnpm/vitae-eius-molestiae
```
...
```typescript
import { assertIsString } from "@wemnyelezxnpm/vitae-eius-molestiae";
...
```typescript
import { StringAssertionError } from "@wemnyelezxnpm/vitae-eius-molestiae";
```
...
```typescript
import { isString } from "@wemnyelezxnpm/vitae-eius-molestiae";
